...
from dlt_cratedb.impl.cratedb.cratedb import (
    CrateDbClient,
)
...
def test_create_table(client: CrateDbClient) -> None:
    ...
    # sqlfluff.parse(sql, dialect="postgres")  # noqa: ERA001
...
def test_create_table_case_sensitive(cs_client: CrateDbClient) -> None:
    ...
    assert cs_client.sql_client.fully_qualified_dataset_name(False)[0] == "T"  # Test
